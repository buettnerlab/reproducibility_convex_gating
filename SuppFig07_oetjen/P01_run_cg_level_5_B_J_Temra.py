...
for sample in samples:
    ...
    if not os.path.exists(target_folder + 'P01_' + level + 'Temra_' + sample):
        os.mkdir(target_folder + 'P01_' + level + 'Temra_' + sample)
    subpath = os.path.join(target_folder + 'P01_' + level + 'Temra_' + sample, sample)
